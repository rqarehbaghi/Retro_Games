#!/usr/bin/env python3
# LEGACY: the original SuperMarioBros3-specific PPO trainer, kept verbatim.
#
# train.py is now the generic, games.json-driven trainer for ANY game. This file
# is the SMB3 pipeline as it was before that change -- its tuned wrappers
# (AutoAdvanceLevel, RewardShaper, TileDetector, SpriteObservation,
# JumpIncentiveWrapper) and its ~25 SMB3 flags are not all expressible in the
# declarative reward vocabulary yet, and they encode a lot of measured tuning.
# It still runs exactly as before:
#
#     python train_smb3_legacy.py --game SuperMarioBros3-Nes-v0 ...
#
# Other modules import ACTION_TABLE from here.
"""
